...
export function App() {
  ...
  const [events, setEvents] = useState(
    [
      {
        theme: themes[0],
        cover: "/public/images/tecboard-cards-background-1.png",
      ...
      {
        theme: themes[0],
        cover: "/public/images/tecboard-cards-background-2.png",
      ...
      {
        theme: themes[1],
        cover: "/public/images/tecboard-cards-background-3.png",
      ...
      {
        theme: themes[1],
        cover: "/public/images/tecboard-cards-background-4.png",
      ...
      {
        theme: themes[1],
        cover: "/public/images/tecboard-cards-background-5.png",
      ...
      {
        theme: themes[2],
        cover: "/public/images/tecboard-cards-background-6.png",
      ...
      {
        theme: themes[3],
        cover: "/public/images/tecboard-cards-background-7.png",
      ...
      {
        theme: themes[3],
        cover: "/public/images/tecboard-cards-background-8.png",
      ...
      {
        theme: themes[4],
        cover: "/public/images/tecboard-cards-background-9.png",
      ...
      {
        theme: themes[4],
        cover: "/public/images/tecboard-cards-background-10.png",
      ...
      {
        theme: themes[4],
        cover: "/public/images/tecboard-cards-background-11.png",
      ...
      {
        theme: themes[4],
        cover: "/public/images/tecboard-cards-background-12.png",
      ...
      {
        theme: themes[5],
        cover: "/public/images/tecboard-cards-background-13.png",
      ...
      {
        theme: themes[5],
        cover: "/public/images/tecboard-cards-background-14.png",
              ...
              <section key={theme.id} className={styles.card}>
                ...
                <div className={styles.cardEvents}>
                  {events
                    ...
                    .map((event) => {
                      return <Card event={event} key={`${theme.id}-${event.title}`} />;
                    })
                  }
                </div>
              </section>
